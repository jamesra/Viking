...
namespace TriangleNet.Topology
{
    ...
    public class Triangle : ITriangle
    {
        ...
        public int GetVertexID(int index) => this.vertices[index].id;
        ...
        public ITriangle GetNeighbor(int index) => neighbors[index].tri.hash == Mesh.DUMMY ? null : neighbors[index].tri;
