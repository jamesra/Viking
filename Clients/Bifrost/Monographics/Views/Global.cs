...
//        static public VertexDeclaration VertexPositionColorTextureDecl = null;
        ...
        static private VertexPositionColorTexture[] CircleVerticies(Geometry.Vector2 Pos, float Radius, Microsoft.Xna.Framework.Color color)
        {
                                   ...
                                   Microsoft.Xna.Framework.Color color)
        {
            ...
            Geometry.Vector2[] verts = LineVerticies.ToArray();
                                   ...
                                   Microsoft.Xna.Framework.Color color)
        {
            ...
            Geometry.Vector2[] verts = Vertices.ToArray();
