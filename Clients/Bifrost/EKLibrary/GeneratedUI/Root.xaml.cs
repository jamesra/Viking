...
namespace EmptyKeys.UserInterface.Generated {
    ...
    public partial class Root : UIRoot {
        ...
        private void InitializeComponent() {
            ...
            this.e_0.Children.Add(this.RenderCanvas);
            this.RenderCanvas.Name = "RenderCanvas";
            Grid.SetColumn(this.RenderCanvas, 1);
            Grid.SetRow(this.RenderCanvas, 1);
            // e_3 element
            this.e_3 = new Image();
            this.RenderCanvas.Children.Add(this.e_3);
            this.e_3.Name = "e_3";
            Grid.SetColumn(this.e_3, 2);
            Grid.SetRow(this.e_3, 2);
            Binding binding_e_3_Source = new Binding("RenderTargetSource");
            this.e_3.SetBinding(Image.SourceProperty, binding_e_3_Source);
        }
    }
}
