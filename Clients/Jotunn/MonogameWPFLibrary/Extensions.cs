namespace MonogameWPFLibrary
{
    ...
    {
        public static Microsoft.Xna.Framework.Vector2 ToXNAVector2(this Geometry.Vector2 v)
        {
            return new Microsoft.Xna.Framework.Vector2((float)v.X, (float)v.Y);
        }

        public static Microsoft.Xna.Framework.Vector3 ToXNAVector3(this Geometry.Vector3 v)
        {
            return new Microsoft.Xna.Framework.Vector3((float)v.X, (float)v.Y, (float)v.Z);
        }

        public static Microsoft.Xna.Framework.Vector3 ToXNAVector3(this Geometry.Vector2 v, double z = 0)
        {
            return new Microsoft.Xna.Framework.Vector3((float)v.X, (float)v.Y, (float)z);
        }

        public static Geometry.Vector3 ToVector3(this Microsoft.Xna.Framework.Vector3 v)
        {
            return new Geometry.Vector3(v.X, v.Y, v.Z);
        }

        public static Geometry.Vector3 ToVector3(this Microsoft.Xna.Framework.Vector2 v, double z = 0)
        {
            return new Geometry.Vector3(v.X, v.Y, z);
        }
    }
