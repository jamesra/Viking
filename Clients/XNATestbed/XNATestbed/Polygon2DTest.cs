...
namespace XNATestbed
{
    ...
    {
        private static GridVector2[] CreateTestPolygon(GridVector2? offset = new GridVector2?())
        {
        ...
        private static GridVector2[] CreateInteriorRing(GridVector2? offset = new GridVector2?())
        {
