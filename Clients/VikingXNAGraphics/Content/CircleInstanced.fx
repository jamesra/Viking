...
technique CircleInstancedAlpha
{
    pass P0
    {
        VertexShader = compile vs_4_0 CircleInstancedVertexShader();
        PixelShader = compile ps_4_0 CircleInstancedPixelShaderAlpha();
    }
}
...
technique CircleInstancedLuma
{
    ...
    {
        VertexShader = compile vs_4_0 CircleInstancedVertexShader();
        PixelShader = compile ps_4_0 CircleInstancedPixelShaderLuma();
    }
}
