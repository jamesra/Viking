...
namespace VikingXNAGraphics
{
    ...
    public class CurveView : IColorView, IRenderable
    {
        ...
        public CurveView(ICollection<GridVector2> controlPoints, Color color, bool TryToClose, uint numInterpolations=5,
        ...
        private static CircleView[] CreateControlPointViews(ICollection<GridVector2> ControlPoints, double? Radius, Color color, Texture2D texture)
        {
            if (Radius.HasValue)
            {
                if (texture != null)
        ...
        public static void Draw(GraphicsDevice device, VikingXNA.Scene scene, RoundCurve.CurveManager CurveManager, 
                                ...
                                Color Color, double LineWidth = 16.0)
        {
            Color pointColor = ControlPointColor(Color);
        ...
        public void Draw(GraphicsDevice device, RoundLineCode.RoundLineManager LineManager, VikingXNA.Scene scene, BasicEffect basicEffect)
        {
            Color pointColor = ControlPointColor(Color);
