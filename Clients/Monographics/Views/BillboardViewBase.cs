...
namespace VikingXNAGraphics
{
    public abstract class BillboardViewBase : IColorView, IViewPosition2D, IRenderable, IViewBoundingRect
    {
        ...
        public virtual Color HSLColor => _HSLColor;
        ...
        public static VertexPositionColorTexture[] GetRenderableVerticies(VertexPositionColorTexture[] PositionedVerticies, Color HSLColor, out int[] indicies)
        {
