...
namespace VikingXNAGraphics
{
    ...
    public static class GlobalPrimitives
    {
        ...
        private static VertexPositionColorTexture[] CircleVerticies(GridVector2 Pos, float Radius, Color color)
        {
                                   ...
                                   Color color)
        {
            ...
            {
                drawn_lines[i] = new RoundLineCode.RoundLine(new Vector2((float)verts[i].X, (float)verts[i].Y),
                                                             new Vector2((float)verts[i + 1].X, (float)verts[i + 1].Y));
            }
