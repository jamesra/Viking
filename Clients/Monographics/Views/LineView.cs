...
namespace VikingXNAGraphics
{
    public class LineView : IColorView, IViewPosition2D, IRenderable
    {
        ...
        protected Color _HSLColor;

        public LineView(GridVector2 source, GridVector2 destination, double width, Color color, LineStyle lineStyle)
        {
        ...
        public LineView(GridLineSegment line, double width, Color color, LineStyle lineStyle) : this(line.A, line.B, width, color, lineStyle)
        {
        }
