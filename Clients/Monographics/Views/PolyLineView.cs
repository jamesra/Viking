...
namespace VikingXNAGraphics
{
    public class PolyLineView : IColorView, IRenderable
    {
        ...
        public PolyLineView(Color color, 
        ...
        public PolyLineView(IEnumerable<GridVector2> controlPoints, Color color, Texture2D texture = null, double lineWidth = 16.0, LineStyle lineStyle = LineStyle.Standard)
        {
        ...
        public PolyLineView(IEnumerable<IPoint2D> controlPoints, Color color, Texture2D texture = null, double lineWidth = 16.0, LineStyle lineStyle = LineStyle.Standard) :
        ...
        private static CircleView[] CreateControlPointViews(IList<GridVector2> ControlPoints, double Radius, Color color, Texture2D texture)
        {
        ...
        private static CircleView CreateControlPointView(GridVector2 ControlPoint, double Radius, Color color, Texture2D texture)
        {
            if (texture != null)
        ...
        /// <returns></returns>
        private static Color ControlPointColor(Color color)
        {
            return new Color(255 - (int)color.R, 255 - (int)color.G, 255 - (int)color.B, (int)color.A / 2f);
            //return color;
        }
        ...
        public static void DrawControlPoints(GraphicsDevice device,
