...
namespace VikingXNAGraphics
{
    ...
    public class CurveLabel : IText, IColorView
    {
        ...
        /// <returns></returns>
        public static CurveLabel CreateLineLabel(string label, GridLineSegment line, Color color,
        ...
        public CurveLabel(string label, ICollection<GridVector2> controlPoints, Color color,
        ...
        public static RenderTarget2D CreateTextureForLabel(string label, GraphicsDevice device,
