...
namespace RoundLineCode
{
    ...
    public class RoundLineManager : VikingXNAGraphics.IInitEffect
    {
        ...
        protected Vector4[] translationData;
        ...
        {
            get => this.dashLengthParameter.GetValueSingle();
            set => this.dashLengthParameter.SetValue(value);
        }

        /// <summary>
        /// Indicates if the draw function of this line manager expects HSL colors or RGB colors
        /// </summary>
        public virtual bool UseHSLColor => false;
        ...
        protected void CreateRoundLineMesh()
        {
            ...
            translationData = new Vector4[MaxInstancesPerBatch]; // Used in Draw()
            ...
            for (int instance = 0; instance < MaxInstancesPerBatch; instance++)
            {
                ...
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, -1.0f, 0), new Vector2(1, threePi2), new Vector2(0, 1f), instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, threePi2), new Vector2(0, 1f), instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, threePi2), new Vector2(0, 0), instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, pi2), new Vector2(0, 1f), instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, pi2), new Vector2(0, 0), instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 1.0f, 0), new Vector2(1, pi2), new Vector2(0, 1f), instance);
    ...
    public class LumaOverlayRoundLineManager : RoundLineManager
    {
        ...
        public override bool UseHSLColor => true;
