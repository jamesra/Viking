...
namespace VikingXNAGraphics
{
    ...
    {
        public static Vector2 ToXNAVector2(this Geometry.GridVector2 vec)
        {
        ...
        public static Vector3 ToXNAVector3(this Geometry.GridVector3 v) => new Vector3((float)v.X, (float)v.Y, (float)v.Z);

        public static Vector3 ToXNAVector3(this Geometry.GridVector2 v, double z = 0) => new Vector3((float)v.X, (float)v.Y, (float)z);

        public static Geometry.GridVector2 ToGridVector2XY(this Vector3 v)
        {
            return new Geometry.GridVector2(v.X, v.Y);
        }

        public static Geometry.GridVector3 ToGridVector3(this Vector3 v)
        {
            return new Geometry.GridVector3(v.X, v.Y, v.Z);
        }

        public static Geometry.GridVector3 ToGridVector3(this Vector2 v, double z = 0)
        {
    ...
    public static class ColorExtensions
    {
        ...
        public static Color SetAlpha(this Color color, float alpha)
        {
            ...
            return new Color(colorVector.X, colorVector.Y, colorVector.Z, alpha);
        }

        public static Color Invert(this Color color, float? alpha = new float?())
        {
            ...
            return new Color(colorVector.X, colorVector.Y, colorVector.Z, alpha.Value);
        }

        private static Color ToXNAColor(int[] ARGB)
        {
            return new Color(ARGB[1],
                                                    ARGB[2],
                                                    ARGB[3],
                                                    ARGB[0]);
        }
        ...
        private static Color ToXNAColor(byte[] ARGB)
        {
            return new Color(ARGB[1],
                                                    ARGB[2],
                                                    ARGB[3],
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static Color CreateGrayscale(double value)
        {
        ...
        public static Color ToXNAColor(this int color, float alpha)
        {
        ...
        public static Color ToXNAColor(this int color)
        {
            byte[] ARGB = GetColorComponents(color);
            return ToXNAColor(ARGB);
        }

        public static Color ToXNAColor(this uint color, float alpha)
        {
            byte[] ARGB = GetColorComponents(color);
            ARGB[0] = (byte)(alpha * 255.0f);
            return ToXNAColor(ARGB);
        ...
        public static Color ToXNAColor(this uint color)
        {
            byte[] ARGB = GetColorComponents(color);
            return ToXNAColor(ARGB);
        }
        ...
        /// <param name="color"></param>
        /// <returns></returns>
        public static HSLColor GetHSL(this Color color)
        {
        ...
        public static Color ConvertToHSL(this Color color, float alpha)
        {
        ...
        public static Color ConvertToHSL(this Color color)
        {
        ...
        /// <returns></returns>
        public static Color AdjustHSLHue(this Color colorHSL, float rotation_degrees, float? alpha= null)
        {
