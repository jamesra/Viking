...
namespace VikingXNAGraphics.Controls
{
    ...
    public class CircularButton : IClickable, IColorView
    {
        ...
        /// <returns></returns>
        public static CircularButton CreateSimple(GridCircle circle, Color color, Action action)
        {
        ...
        public CircularButton(GridCircle circle, Color color, InputDeviceEventConsumerDelegate OnClick =null)
        {
