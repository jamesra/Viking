...
namespace MonogameTestbed
{
    ...
    class BajajOTVAssignmentView
    {
        ...
        public BajajOTVAssignmentView(IShape2D[] shapes, double[] Z)
        {
            ...
            {
                //Create our mesh with only the verticies
                FirstPassTriangulation = new BajajGeneratorMesh(Shapes, ShapeZ, ShapeZ.Select(z_ => z_ != MinZ).ToArray());
                GenerateMesh(FirstPassTriangulation);
            }); 
        }
        ...
        */
        ...
        public static PointSetView CreateCompletedVertexView(List<MorphMeshVertex> verticies, Color color)
        {
            PointSetView psv = new PointSetView
            {
                ...
                LabelIndex = true,
                PointRadius = 1.25,
                Points = verticies.Select(v => v.Position.XY()).ToArray()
            };
            return psv; 
        }
        ...
        */
        ...
        internal static MeshModel<VertexPositionColor> CreateFaceView(MorphRenderMesh mesh)
        {
            ...
            MeshModel<VertexPositionColor> model = new MeshModel<VertexPositionColor>
            {
                ...
                Verticies = mesh.Verticies.Select((v, i) => new VertexPositionColor(v.Position.ToXNAVector3(), GetVertColor(mesh, v))).ToArray() //Color.Orange.SetAlpha(0.5f) /*ColorExtensions.CreateGrayscale((v.Position.Z - MinZ) / (MaxZ - MinZ))*/)).ToArray();
            };
        ...
        */
        ...
        {
            return BajajMeshGenerator.IsSliceChordValid(sc.Origin, mesh.Shapes, mesh.GetSameLevelShapes(sc), mesh.GetAdjacentLevelShapes(sc), sc.Target, ChordRTree, Tests, out failures);
        }
        ...
        public void Draw(MonoTestbed window, Scene scene)
        {
            ...
            LabelView label = new LabelView(ViewLabels.ToString(), scene.VisibleWorldBounds.UpperLeft, anchor: Anchor.TopLeft, scaleFontWithScene: false);
    ...
    class BajajAssignmentTest : IGraphicsTest
    {
        ...
        /// </summary>
        readonly ulong[] DelaunayTest9 = new ulong[] {
            58687,
            58685
        };
        ...
        /// </summary>
        readonly ulong[] DelaunayTest10 = new ulong[] {
            108603,
            108610,
            108534
        };
        ...
        /// </summary>
        readonly ulong[] DelaunayTest11 = new ulong[]
        {
            102640,
            102645,
            102436
        ...
        /// </summary>
        readonly ulong[] DelaunayTest12 = new ulong[]
        {
            102557,
            102564,
            263477,
        ...
        /// </summary>
        readonly ulong[] DelaunayTest13 = new ulong[]
        {
            58685,
            58682
        };
        readonly ulong[] DelaunayTest14 = new ulong[]
        {
            58708,
            58706
        };
        readonly ulong[] DelaunayTest15 = new ulong[]
        {
            82356,
            58677
        };
        ...
        readonly ulong[] DelaunayTest16 = new ulong[] 
        {
            105877,
            105879,
            105837
        ...
        readonly ulong[] DelaunayTest17 = new ulong[]
        {
            133018 ,
            133001
        };
        ...
        readonly ulong[] DelaunayTest18 = new ulong[]
        {
            145437 ,
            145435
        };
        readonly ulong[] DelaunayTest19 = new ulong[]
        {
            82607 ,
            82604
        };
        readonly ulong[] DelaunayTest20 = new ulong[]
        {
            139799 ,
            139796
        };
        ...
        readonly BajajRepro[] ReproSet =
        {
            ...
            new BajajRepro(269861, 269862, DataSource.EndpointMap[Endpoint.RPC1], "QuadTreeWithUniqueValues: : 'Index was out of range."),
