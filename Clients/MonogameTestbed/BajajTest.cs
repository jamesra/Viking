...
namespace MonogameTestbed
{
    ...
    class BajajOTVAssignmentView
    {
        ...
        */
        ...
        public void Draw(MonoTestbed window, Scene scene)
        {
            ...
            LabelView label = new(ViewLabels.ToString(), scene.VisibleWorldBounds.UpperLeft, anchor: Anchor.TopLeft, scaleFontWithScene: false);
        ...
        public void Draw3D(MonoTestbed window, Scene3D scene)
        {
            ...
            LabelView label = new(ViewLabels.ToString(), window.Scene.VisibleWorldBounds.UpperLeft, anchor: Anchor.BottomLeft, scaleFontWithScene: false);
    ...
    class BajajRepro
    {
        ...
        {
            Morphology = AnnotationVizLib.OData.ODataMorphologyFactory.FromOData([.. SliceLocations.Select(id => (long)id)], true, Endpoint);
