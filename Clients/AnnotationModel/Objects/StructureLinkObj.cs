...
{
    public struct StructureLinkKey : IEquatable<StructureLinkKey>, IComparable<StructureLinkKey>, IStructureLinkReadOnly
    {
        ...
        ulong IStructureLinkReadOnly.SourceID => (ulong)SourceID;

        ulong IStructureLinkReadOnly.TargetID => (ulong)TargetID;

        bool IStructureLinkReadOnly.Directional => this.Bidirectional == false;
        ...
        public override bool Equals(object obj)
        {
            ...
            IStructureLinkReadOnly other = obj as IStructureLinkReadOnly;
            if (other == null)
                return false;

            return ((IStructureLinkReadOnly)this).Equals(other);
        }
        ...
        bool IEquatable<IStructureLinkReadOnly>.Equals(IStructureLinkReadOnly other)
        {
