...
namespace VikingXNAGraphics
{
    public class ScaledLabelView : LabelView
    {
        ...
        public override Geometry.Rectangle BoundingRect
        {
            ...
            get
            {
                ...
                return new Geometry.Rectangle(this.Position + offset, label_size.X, label_size.Y);
            }
        }
    ...
    public class LabelView : IText, IColorView, IViewPosition2D, IRenderable, IAnchor, IAlignment
    {
        ...
        /// </summary>
        protected Geometry.Rectangle UnanchoredUnscaledBoundingRect
        {
            get
            {
                if (!_IsMeasured)
                ...
                return new Geometry.Rectangle(this.Position, Width, Height);
            }
        }


        public virtual Geometry.Rectangle BoundingRect
        {
        ...
        /// </summary>
        public Geometry.Rectangle GetAnchoredBoundingRect(IScene scene)
        {
            if (!_IsMeasured)
            {
                MeasureLabel();
            ...
            return new Geometry.Rectangle(this.Position + offset, Width * FontScaleForVolume, Height * FontScaleForVolume);
        }
        ...
        /// <returns></returns>
        public double GetFontSizeToFitBounds(Geometry.Rectangle bbox, Geometry.Vector2? Padding_factor = null)
        {
        ...
        */
        ...
        private static Vector2 AlignmentAdjustmentForRow(Vector2 row_measurement, Geometry.Rectangle bounds, Vector2 max_row_size, Alignment alignment)
        {
            Vector2 origin = new();
                            ...
                            VikingXNA.IScene scene)
        {
            ...
            Geometry.Rectangle bounds = BoundingRect;
