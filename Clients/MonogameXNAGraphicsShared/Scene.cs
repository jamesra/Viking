        ...
        public Geometry.Rectangle VisibleWorldBounds
        {
            get
            {
                ...
                try
                {
                    ...
                    double offset = 0;
                    Geometry.Rectangle projectedArea = new(new Geometry.Vector2(0, 0), ((double)_Viewport.Width * Camera.Downsample), (double)_Viewport.Height * Camera.Downsample); ;
                    var BottomLeft = ScreenToWorld(offset, _Viewport.Height);
                    Geometry.Rectangle result = new(BottomLeft, projectedArea.Width, projectedArea.Height);
