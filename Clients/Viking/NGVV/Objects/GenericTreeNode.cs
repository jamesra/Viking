...
public class GenericTreeNode : System.Windows.Forms.TreeNode
{
    ...
    protected virtual void OnObjectDelete(object sender, System.EventArgs e) => this.TreeView?.RemoveNode(this);
    ...
    public void UpdateChildNodes()
    {
        ...
        Dictionary<IUIObject, GenericTreeNode> NodesToDelete = [];
    ...
    {
        if (this.Nodes.Count == 0 && Object != null)
    ...
    /// </summary>
    private static readonly System.Collections.Hashtable _TreeViewVisibleChildPropertiesByType = [];
    ...
    protected static System.Reflection.PropertyInfo[] GetPropertiesForType(System.Type T)
    {
        ...
        PropertyInfo[] propInfoArray = [.. propInfoList];
