...
namespace WebAnnotation.ViewModel
{
    ...
    public class Location_CanvasCircleAnnotationViewModel : Location_CanvasViewModel
    { 
        ...
        {
            return LineSpacing * baseScale < Location_CanvasCircleAnnotationViewModel.LabelVisibleCutoff;
        }
                              ...
                              int DirectionToVisiblePlane)
        {
            ...
            if (DirectionToVisiblePlane == 0)
            {
                ...
                foreach (KeyValuePair<Location_CanvasCircleAnnotationViewModel, GridCircle> adjLoc in this.OverlappingLinkedLocationCircles)
                {
        ...
        /// </summary>
        private ConcurrentDictionary<Location_CanvasCircleAnnotationViewModel, GridCircle> _OverlappingLinkedLocationCircles = null;
        public ConcurrentDictionary<Location_CanvasCircleAnnotationViewModel, GridCircle> OverlappingLinkedLocationCircles
        {
            get
            {
