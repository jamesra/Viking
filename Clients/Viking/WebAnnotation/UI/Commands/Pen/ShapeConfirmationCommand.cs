...
namespace WebAnnotation.UI.Commands
{
    ...
    public class ShapeConfirmationCommand : Viking.UI.Commands.Command
    {
        ...
        private readonly List<CircularButton> Buttons = [];
        ...
        public override void OnDraw(GraphicsDevice graphicsDevice, Scene scene, BasicEffect basicEffect)
        {
            ...
            */
            ...
            {
                PolyLineView.Draw(graphicsDevice, scene, OverlayStyle.Alpha, [DrawnShape1D]);
            }
        ...
        protected override void OnMouseMove(object sender, MouseEventArgs e) => base.OnMouseMove(sender, e);
        ...
        protected override void OnPenMove(object sender, PenEventArgs e) => base.OnPenMove(sender, e);
