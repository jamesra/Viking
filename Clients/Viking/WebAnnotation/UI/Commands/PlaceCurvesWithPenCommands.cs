...
namespace WebAnnotation.UI.Commands
{
    internal class PlaceClosedCurveWithPenCommand : PlaceGeometryWithPenCommandBase
    {
        ...
        protected virtual bool IsProposedClosedLoopValid(IReadOnlyCollection<Geometry.Vector2> proposed_curve) => true;
    ...
    internal abstract class PlaceGeometryWithPenCommandBase : LineGeometryCommandBase, Viking.Common.IHelpStrings, Viking.Common.IObservableHelpStrings
    {
        ...
        public virtual void InitPath(IReadOnlyCollection<Geometry.Vector2> path)
        {
            ...
            foreach (Geometry.Vector2 p in path)
            {
                PenInput.Push(p);
                PathView.Add(p);
            }
        ...
        protected virtual void OnPenPathChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            switch (e.Action)
            {
                ...
                case NotifyCollectionChangedAction.Reset:
                    PathView.ControlPoints = new Geometry.Vector2[0];
                    break;
                default:
        ...
        protected abstract void OnPenPathComplete(object sender, Geometry.Vector2[] Path);
