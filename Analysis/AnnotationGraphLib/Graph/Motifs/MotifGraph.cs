    ...
    public class MotifGraph : Graph<string, MotifNode, MotifEdge>
    {
        ...
        public static MotifGraph BuildGraph(string Endpoint, System.Net.NetworkCredential userCredentials)
        {
            ...
            using (AnnotateStructuresClient proxy = ConnectionFactory.CreateStructuresClient())
            {
                ...
                Structure[] linkedStructures = proxy.GetStructuresByIDs(StructIDToLinks.Keys.ToArray(), false);
                ...
                Structure[] ParentStructures = proxy.GetStructuresByIDs(ParentIDs.ToArray(), false); //Don't query child structures because we know the linked ones
                ...
                graph.Edges.AddRange(dictEdges.Values); 
            }
