...
namespace gRPCAnnotationServiceCore.Protos
{
    ...
    {
        public static implicit operator Location(global::AnnotationService.Types.Location src)
        {
        ...
        public static implicit operator global::AnnotationService.Types.Location(Location src)
        {
            var value = new global::AnnotationService.Types.Location {
                ParentID = src.ParentId,
                Section = src.Section,
                Position = (global::AnnotationService.Types.AnnotationPoint)src.Position,
                VolumePosition = (global::AnnotationService.Types.AnnotationPoint)src.VolumePosition,
