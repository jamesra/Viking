...
namespace Geometry.Transforms
{
    class AddTransformThreadObj : IDisposable
    {
        ...
        public AddTransformThreadObj(int[] iMapPoints, TriangulationTransform warpingT, ITransform fixedT)
        {
        ...
        { 
            ...
            List<MappingGridVector2> newPointsList = MappedControlPoints.Select((cp, i) => new MappingGridVector2(cp, warpingTransform.MapPoints[i].MappedPoint)).ToList();
