...
namespace Geometry
{
    ...
    public class RegionPyramid<T> where T : class
    {
       ...
       public RegionPyramidLevel<T> GetLevelForScreenBounds(GridRectangle screenBounds, double SinglePixelRadius)
        ...
        /// 
        /// </summary>
        /// <param name="screenBounds">Boundaries in screen coordinates, i.e. 1920x1080</param>
        /// <param name="SinglePixelRadius"></param>
        /// <returns></returns>
        public T[] TilesForScreenBounds(GridRectangle screenBounds, double SinglePixelRadius)
       {
            GridRectangle volumeBounds = new GridRectangle(screenBounds.Left, screenBounds.Right, screenBounds.Bottom, screenBounds.Top);
            volumeBounds.Scale(SinglePixelRadius);
            return VisibleTiles(screenBounds, volumeBounds, SinglePixelRadius);
        }
        ...
        /// 
        /// </summary>
        /// <param name="volumeBounds">Boundaries in volume space</param>
        /// <param name="SinglePixelRadius">Size of a single pixel </param>
        /// <returns></returns>
        public T[] TilesForVolumeBounds(GridRectangle volumeBounds, double SinglePixelRadius)
        {
            GridRectangle screenBounds = new GridRectangle(volumeBounds.Left, volumeBounds.Right, volumeBounds.Bottom, volumeBounds.Top);
            screenBounds.Scale(1.0 / SinglePixelRadius);
            return VisibleTiles(screenBounds, volumeBounds, SinglePixelRadius);
        ...
        /// 
        /// </summary>
        /// <param name="visibleBounds">Boundaries in volume space</param>
        /// <param name="SinglePixelRadius">Size of a single pixel </param>
        /// <returns></returns>
        private T[] VisibleTiles(GridRectangle screenBounds, GridRectangle volumeBounds, double SinglePixelRadius)
        { 
            int iLevel = LevelForVisibleBounds(volumeBounds);
            RegionPyramidLevel<T> Level = GetOrAddLevel(iLevel, MinRadiusForLevel(screenBounds, iLevel));
            return Level.ArrayForRegion(volumeBounds);
        }
        ...
        /// <param name="SinglePixelRadius"></param>
        /// <returns></returns>
        public GridRange<T> SubGridForScreenBounds(GridRectangle screenBounds, double SinglePixelRadius)
        {
            GridRectangle volumeBounds = new GridRectangle(screenBounds.Left, screenBounds.Right, screenBounds.Bottom, screenBounds.Top);
            volumeBounds.Scale(SinglePixelRadius);
            return SubGrid(screenBounds, volumeBounds, SinglePixelRadius);
        }
        ...
        /// <param name="SinglePixelRadius">Size of a single pixel </param>
        /// <returns></returns>
        public GridRange<T> SubGridForVolumeBounds(GridRectangle volumeBounds, double SinglePixelRadius)
        {
            GridRectangle screenBounds = new GridRectangle(volumeBounds.Left, volumeBounds.Right, volumeBounds.Bottom, volumeBounds.Top);
            screenBounds.Scale(1.0 / SinglePixelRadius);
            return SubGrid(screenBounds, volumeBounds, SinglePixelRadius);
        ...
        /// <param name="SinglePixelRadius">Size of a single pixel </param>
        /// <returns></returns>
        private GridRange<T> SubGrid(GridRectangle screenBounds, GridRectangle volumeBounds, double SinglePixelRadius)
        {
            int iLevel = LevelForVisibleBounds(volumeBounds);
            RegionPyramidLevel<T> Level = GetOrAddLevel(iLevel, MinRadiusForLevel(screenBounds, iLevel));
            return Level.SubGridForRegion(volumeBounds);
        }
        */
    }
}
