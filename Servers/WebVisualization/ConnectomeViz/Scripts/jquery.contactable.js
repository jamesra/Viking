...
(function ($) {
    ...
    $.fn.contactable = function (options) {
        //set default options  
        var defaults = {
            url: Url + "FormRequest/SendMessage",
            name: 'Name',
            email: 'Email',
            message: 'Message',
            subject: 'Message from Viz User',
            submit: 'SEND',
            recievedMsg: 'Thank you for your message',
            notRecievedMsg: 'Sorry but your message could not be sent, try again later',
            disclaimer: 'We value your feedback. Please let us know of any problems you encounter or suggestions you may have for improvement.',
            hideOnSubmit: false

        };

        //call in the default option
        ...
        return this.each(function () {
            ...
            $(this_id_prefix + '#name').val(userName);
            $(this_id_prefix + '#email').val(userEmail);
            //show / hide function
