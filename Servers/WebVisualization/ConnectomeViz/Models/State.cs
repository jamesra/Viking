...
namespace ConnectomeViz.Models
{
    ...
    public static class State
    {
        ...
        {
            get { return State._selectedServer; }
            set { State._selectedServer = value; }
        }

        private static string _selectedServer = "connectomes.utah.edu";

        public static ServerData SelectedServerData
        {
            get
            {
                return ServerToEndpointURLBase[State.selectedServer];
            } 
        }
