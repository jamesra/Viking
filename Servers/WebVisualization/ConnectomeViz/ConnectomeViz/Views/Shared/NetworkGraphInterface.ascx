...
<div>
    ...
    <select name="hops">
        ...
        <input type="submit" id="submitButton" value="Go" onclick="OnSubmit()" />
        <img id="progress" style="visibility: hidden;" height="25" width="25" src="" align="absmiddle"
            alt="Loading..." />
        <br />
        <br />
        Update Graph</strong>&nbsp;&nbsp;&nbsp;
    <input name="freshQuery" id="freshQuery" type="checkbox" value="latest" />&nbsp;&nbsp;<strong>|</strong>&nbsp;&nbsp;
    <strong>Reduce edges</strong>&nbsp;&nbsp;<input name="reduceEdges" id="reduceEdges"
        type="checkbox" value="reduce" checked="checked" />&nbsp;&nbsp;<strong>|</strong>&nbsp;&nbsp;
    <strong>Anatomic Node Positions</strong>&nbsp;&nbsp;<input name="pinNodes" id="pinNodes"
        type="checkbox" value="nodepos" />
    <br />
    <br />
    <strong>Interactive Graph </strong>
    <input type="radio" name="group1" value="generate" id="svgGraph" checked="checked" />
    &nbsp;&nbsp;<strong>|</strong>&nbsp;&nbsp; <strong>Flash Graph</strong><input type="radio"
        name="group1" value="flash" id="flashGraph" />
    <br />
    </label>
</div>
<style type="text/css">
