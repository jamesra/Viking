...
namespace ConnectomeViz.Controllers
{
    ...
    public class NetworkController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ConnectomeViz.ViewModels.ServersVolumes Servers = new ViewModels.ServersVolumes();

            Servers.SelectedServer = State.selectedServer;
            Servers.SelectedVolume = State.selectedVolume;
            Servers.Volumes = new SelectList(State.ServerToEndpointURLBase.Keys);
            Servers.Volumes = new SelectList(State.ServerToEndpointURLBase[Servers.SelectedServer].Volumes);
        ...
        ********************/     
        ...
        public ActionResult Trace()
        {
            ...
            string OutputFilenameBase= State.selectedServer+"_"+State.selectedVolume+"_"+cellid+"_"+hops+"_"+reduce+"_"+position;
            ...
            {
                NeuronGraph graph = AnnotationUtils.NeuronGraph.BuildGraph(new long[] { cellid }, hops, State.SelectedEndpoint, State.userCredentials);

                NeuronDOTView dotGraph = NeuronDOTView.ToDOT(graph); 
