  ...
  <script type="text/javascript" src="<%=webPath%>/Scripts/mooRainbow.js"></script>--%>
    ...
    <div id="Controls">
        ...
        <label style="font-size: medium">
            ...
            &nbsp;<br />
            &nbsp; Enter Cell ID&nbsp;&nbsp;&nbsp; :</label>&nbsp;&nbsp;&nbsp;
        <input type="text" id="cellID" name="cellID" onkeydown="update_button()" onkeyup="update_button()"
            onfocus="update_button()" onmousemove="update_button()" onchange="update_button()"
            onkeypress="update_button()" onmouseout="update_button()" autocomplete="off"
            title="Enter a Cell ID" />
        &nbsp;<label style="font-size: medium"></label>
        <label style="font-size: medium">
            (or) Choose from List :
            <asp:DropDownList ID="labelPatternList" clientIDMode="Static" onchange="update_button1()"
                runat="server">
            </asp:DropDownList>
        ...
        <select name="hops">
        ...
        </select><strong><span class="Apple-style-span" style="border-collapse: separate;
            ...
            <input name="freshQuery" id="freshQuery" type="checkbox" value="latest" />
            Update Graph&nbsp;&nbsp;&nbsp;&nbsp; </strong>
        <input type="submit" id="submitButton" value="Go" onclick="animate()" />&nbsp;
        <label id="message" style="font-size: small">
        </label>
        <img id="progress" style="visibility: hidden;" height="25" width="25" src="" align="absmiddle"
            alt="Loading..." />
        <br />
        <br />
        &nbsp;
        <input type="radio" name="group1" value="generate" id="Radio1" checked="checked" />
        <strong>Interactive Graph </strong>&nbsp;<input type="radio" name="group1" value="flash"
            id="flashGraph" />
        <strong>Flash Graph</strong> &nbsp;<strong> |</strong>&nbsp;&nbsp;
        <input name="reduceEdges" id="reduceEdges" type="checkbox" value="reduce" checked="checked" /><strong>Reduce
            edges</strong>&nbsp;&nbsp;
        </form>
        <% bool flash = false;
...
<embed src="<%=ViewData["virtualRoot"]%>/Files/<%= ViewData["username"] %>/<%= ViewData["SVGFile"] %>.svg" type="image/svg+xml" width="1000" height="800" pluginspage="http://www.adobe.com/svg/viewer/install"></embed>

<!--<comment><object data="<%=ViewData["virtualRoot"]%>/Files/<%= ViewData["SVGFile"] %>.svg" type="image/svg+xml" width="1000" height="800" class= "svg" ></object> </comment>-->
            ...
            <tr>
                ...
                <td>
                    <b>
                        ...
                        Zoom to desired size and hit Save buttons below graph
                        <%}
                           else
                           { %>
                        Zoom: Right Click -> "Zoom in", Pan: -
    ...
    <br />
    <div align="center">
        <object data="<%=ViewData["userURL"]%>.svg" type="image/svg+xml" width="100%" height="1024"
            id="SVGGraph">
        </object>
    </div>
    <br />
