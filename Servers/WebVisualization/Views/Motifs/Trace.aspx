 ...
 <script type="text/javascript" src="<%=webPath%>/Scripts/colorpicker.js"></script>
  ...
  <script type="text/javascript" src="<%=webPath%>/Scripts/mooRainbow.js"></script>--%>
    ...
    <input name="reduceEdges" id="reduceEdges"
        type="checkbox" value="reduce" checked="checked" />&nbsp;&nbsp;<strong>Reduce edges</strong>
        <br />     
        <br />     
       <strong>Output type</strong>
        <ul style="list-style: none;">
            <li><input type="radio" name="OutputType" value="dot" id="dotGraph" />&nbsp;&nbsp;<strong>Dot File</strong></li> 
            <li><input type="radio" name="OutputType" value="generate" id="Radio1" checked="checked" />&nbsp;&nbsp;<strong>Interactive Graph </strong></li>
