    ...
    public class MotifGraph : Graph<string, MotifNode, MotifEdge>
    {
        ...
        public static MotifGraph BuildGraph(string Endpoint, System.Net.NetworkCredential userCredentials)
        {
            ...
            using (AnnotateStructuresClient proxy = ConnectionFactory.CreateStructuresClient())
            {
                ...
                Structure[] linkedStructures = GetStructuresByIDs(proxy, StructIDToLinks.Keys.ToArray());
                ...
                Structure[] ParentStructures = GetStructuresByIDs(proxy, ParentIDs.ToArray()); //Don't query child structures because we know the linked ones
        ...
        private static Structure[] GetStructuresByIDs(AnnotateStructuresClient proxy, long[] IDs)
        {
            int i = 0;
            int ChunkSize = 4096;
