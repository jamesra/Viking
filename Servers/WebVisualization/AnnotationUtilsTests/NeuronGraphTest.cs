...
namespace AnnotationUtilsTests
{
    ...
    public class NeuronGraphTest
    {
        ...
        public void GenerateNeuronGraph()
        {
            ...
            AnnotationUtils.NeuronGraph graph = NeuronGraph.BuildGraph(new long[] {476}, 2, this.Endpoint, this.userCredentials);
            ...
            NeuronDOTView dotGraph = AnnotationUtils.NeuronDOTView.ToDOT(graph, true);
