...
namespace Viking.DataModel.Annotation.Migrations
{
    public partial class InitialMigration : Migration
    {
        ...
        { 
            ...
            migrationBuilder.CreateTable(
                name: "NetworkChildStructureIDsResult",
                columns: table => new
                {
                    ID = table.Column<long>(type: "bigint", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "NetworkStructureIDsResult",
                columns: table => new
                {
                    ID = table.Column<long>(type: "bigint", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "SectionLocationLinksModifiedAfterDateResult",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
                name: "SectionLocationLinksResult",
                columns: table => new
                {
                    A = table.Column<long>(type: "bigint", nullable: false),
                    B = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SectionLocationsModifiedAfterDateResult",
                columns: table => new
                {
                    ID = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    Overlay = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    Tags = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Terminal = table.Column<bool>(type: "bit", nullable: false),
                    OffEdge = table.Column<bool>(type: "bit", nullable: false),
                    TypeCode = table.Column<short>(type: "smallint", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Username = table.Column<string>(type: "nvarchar(254)", maxLength: 254, nullable: false, defaultValueSql: "(N'')", comment: "Last username to modify the row"),
                    MosaicShape = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    VolumeShape = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    X = table.Column<double>(type: "float", nullable: false),
                    Y = table.Column<double>(type: "float", nullable: false),
                    VolumeX = table.Column<double>(type: "float", nullable: false),
                    VolumeY = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "StructureLocationLinksResult",
                columns: table => new
                {
                    A = table.Column<long>(type: "bigint", nullable: false),
                    B = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotKey = table.Column<string>(type: "char(1)", unicode: false, fixedLength: true, maxLength: 1, nullable: false, defaultValueSql: "('')", comment: "Hotkey used to create a structure of this type"),
                    Username = table.Column<string>(type: "nvarchar(254)", maxLength: 254, nullable: false, defaultValueSql: "(N'')", comment: "Last username to modify the row"),
            ...
            migrationBuilder.CreateTable(
                name: "ufnLinkedToLocationsResult",
                columns: table => new
                {
