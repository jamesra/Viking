...
INSERT INTO #UpdateVars Values (N'RC2TEST');
...
BEGIN
	...
	set @Path = N'C:\Database\RC2TEST\'
	EXEC master.dbo.xp_create_subdir @Path
	
	/****** Object:  Database [RC2TEST]    Script Date: 06/14/2011 13:13:50 ******/
	CREATE DATABASE [RC2TEST] ON  PRIMARY 
		( NAME = N'RC2TEST', FILENAME = N'C:\Database\RC2TEST\RC2TEST.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
		 LOG ON 
		( NAME = N'TEST_log', FILENAME = N'C:\Database\RC2TEST\TEST_log.ldf' , SIZE = 4096KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
		
	ALTER DATABASE [RC2TEST] SET COMPATIBILITY_LEVEL = 100
	
	IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
	begin
		EXEC [RC2TEST].[dbo].[sp_fulltext_database] @action = 'enable'
	end
	
	ALTER DATABASE [RC2TEST] SET ANSI_NULL_DEFAULT OFF
	ALTER DATABASE [RC2TEST] SET ANSI_NULLS OFF
	ALTER DATABASE [RC2TEST] SET ANSI_PADDING OFF
	ALTER DATABASE [RC2TEST] SET ANSI_WARNINGS OFF
	ALTER DATABASE [RC2TEST] SET ARITHABORT OFF
	ALTER DATABASE [RC2TEST] SET AUTO_CLOSE OFF
	ALTER DATABASE [RC2TEST] SET AUTO_CREATE_STATISTICS ON
	ALTER DATABASE [RC2TEST] SET AUTO_SHRINK OFF
	ALTER DATABASE [RC2TEST] SET AUTO_UPDATE_STATISTICS ON
	ALTER DATABASE [RC2TEST] SET CURSOR_CLOSE_ON_COMMIT OFF
	ALTER DATABASE [RC2TEST] SET CURSOR_DEFAULT  GLOBAL
	ALTER DATABASE [RC2TEST] SET CONCAT_NULL_YIELDS_NULL OFF
	ALTER DATABASE [RC2TEST] SET NUMERIC_ROUNDABORT OFF
	ALTER DATABASE [RC2TEST] SET QUOTED_IDENTIFIER OFF
	ALTER DATABASE [RC2TEST] SET RECURSIVE_TRIGGERS OFF
	ALTER DATABASE [RC2TEST] SET  DISABLE_BROKER
	ALTER DATABASE [RC2TEST] SET AUTO_UPDATE_STATISTICS_ASYNC OFF
	ALTER DATABASE [RC2TEST] SET DATE_CORRELATION_OPTIMIZATION OFF
	ALTER DATABASE [RC2TEST] SET TRUSTWORTHY OFF
	ALTER DATABASE [RC2TEST] SET ALLOW_SNAPSHOT_ISOLATION OFF
	ALTER DATABASE [RC2TEST] SET PARAMETERIZATION SIMPLE
	ALTER DATABASE [RC2TEST] SET READ_COMMITTED_SNAPSHOT OFF
	ALTER DATABASE [RC2TEST] SET HONOR_BROKER_PRIORITY OFF
	ALTER DATABASE [RC2TEST] SET  READ_WRITE
	ALTER DATABASE [RC2TEST] SET RECOVERY SIMPLE
	ALTER DATABASE [RC2TEST] SET  MULTI_USER
	ALTER DATABASE [RC2TEST] SET PAGE_VERIFY CHECKSUM
	ALTER DATABASE [RC2TEST] SET DB_CHAINING OFF
...
SET @compat_level = (SELECT compatibility_level FROM sys.databases WHERE name = 'RC2TEST')
IF(@compat_level < 120)
BEGIN
	print N'Setting the database compatability level to SQL 2014'
	ALTER DATABASE [RC2TEST] SET COMPATIBILITY_LEVEL = 120  
END
GO
