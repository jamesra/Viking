...
namespace ConnectomeDataModel
{
    ...
    public partial class ConnectomeEntities : DbContext
    {
        ...
        public virtual int RecursiveSelectChildStructureIDs()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RecursiveSelectChildStructureIDs");
        }
        ...
        public virtual int SelectNetworkDetails(Nullable<int> hops)
        {
            var hopsParameter = hops.HasValue ?
                new ObjectParameter("Hops", hops) :
                new ObjectParameter("Hops", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SelectNetworkDetails", hopsParameter);
        }
        ...
        public virtual int SelectNetworkStructureLinks(Nullable<int> hops)
        {
            var hopsParameter = hops.HasValue ?
                new ObjectParameter("Hops", hops) :
                new ObjectParameter("Hops", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SelectNetworkStructureLinks", hopsParameter);
        }
    
        public virtual int SelectNetworkStructures(Nullable<int> hops)
        {
            var hopsParameter = hops.HasValue ?
                new ObjectParameter("Hops", hops) :
                new ObjectParameter("Hops", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SelectNetworkStructures", hopsParameter);
        }
    
        public virtual int SelectSectionAnnotationsInBounds(Nullable<double> z, System.Data.Entity.Spatial.DbGeometry bBox, Nullable<double> minRadius, Nullable<System.DateTime> queryDate)
        {
            var zParameter = z.HasValue ?
                new ObjectParameter("Z", z) :
                new ObjectParameter("Z", typeof(double));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SelectSectionAnnotationsInBounds", zParameter, bBoxParameter, minRadiusParameter, queryDateParameter);
        }
    }
}
