...
docker-compose down
docker-compose -f IdentityServer/docker-compose-all.yml --env-file "%IDENTITY_BUILD_ENV_PATH%\.env.All" --env-file "%IDENTITY_BUILD_ENV_PATH%\.env.All.Development" --env-file "%IDENTITY_BUILD_ENV_PATH%\.env.All.Docker" up --build