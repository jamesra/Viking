...
namespace IdentityServer.Data.Migrations.Application
{
    ...
    [Migration("20210325003559_InitialApplicationDatabaseMigration")]
    partial class InitialApplicationDatabaseMigration
    {
            ...
            modelBuilder.Entity("IdentityServer.Models.Resource", b =>
                {
                    ...
                    b.HasDiscriminator<string>("TypeId").HasValue("Resource");
                });
            ...
            modelBuilder.Entity("IdentityServer.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "747fdd8a-2f9e-48ee-ac5e-cec25e832765",
                            ConcurrencyStamp = "1a8edd37-13a5-4bca-a4c4-1e5c487b3757",
                            Name = "Administrator",
