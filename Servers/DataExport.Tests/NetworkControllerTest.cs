...
public class NetworkControllerTest
{
    ...
    public async Task TestNetworkGetDotIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkGetTlpIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkGetGmlIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkGetJsonIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkPostDotIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkPostTlpIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkPostGmlIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
    ...
    [TestMethod]
    [TestCategory("IntegrationTest")]
    public async Task TestNetworkPostJsonIntegration()
    {
        // Arrange
        var mockEnv = CreateMockEnvironment();
        var config = CreateConfiguration();
